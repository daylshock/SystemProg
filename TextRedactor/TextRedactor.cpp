...
// TextRedactor.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTextRedactorApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CTextRedactorApp::OnAppAbout)
...
// Создание CTextRedactorApp

CTextRedactorApp::CTextRedactorApp() noexcept
{
	...
	SetAppID(_T("TextRedactor.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CTextRedactorApp

CTextRedactorApp theApp;


// Инициализация CTextRedactorApp

BOOL CTextRedactorApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CTextRedactorDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CTextRedactorView));
	if (!pDocTemplate)
		return FALSE;
...
int CTextRedactorApp::ExitInstance()
{
...
// Обработчики сообщений CTextRedactorApp
...
void CTextRedactorApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
